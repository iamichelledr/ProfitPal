...
export default function AdminDashboard() {
  ...
  const [submissions, setSubmissions] = useState<UserSubmission[]>([
    ...
    },
    {
      ...
      amount: '₱149',
      status: 'rejected',
      receiptId: 'GC-20240114-004',
    },
    {
      id: '5',
      name: 'Sarah Gomez',
      email: 'sarah.gomez@email.com',
      submittedAt: '2024-01-13 11:30',
      paymentMethod: 'Credit Card',
      amount: '₱1,490',
      status: 'approved',
      receiptId: 'CC-20240113-005',
    },
  ]);
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'approved':
        return <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200"><CheckCircle2 className="w-3 h-3 mr-1" /> Approved</Badge>;
      case 'rejected':
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-pp-dark">{stats.totalUsers}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-pp-violet">{stats.premiumUsers}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-pp-green">{stats.totalRevenue}</p>
          ...
          <CardContent>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredSubmissions.map((submission) => (
                    <tr key={submission.id} className="border-b border-pp-slate/10 hover:bg-pp-blue/5 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <span className="font-mono text-sm text-pp-slate">{submission.receiptId}</span>
                      </td>
                      <td className="py-4 px-4">
            ...
            {filteredSubmissions.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-pp-slate">No submissions found</p>
              </div>
            )}
          </CardContent>
        </Card>
